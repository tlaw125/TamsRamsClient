        ...
        <Sidenav.Body>
          ...
          <Nav>
            ...
            <Dropdown eventKey="3" title="Plants" icon={<FontAwesomeIcon icon={faSeedling} className="fa-icon" />}>
              <Dropdown.Item eventKey="3-1-1" href="/browse/plant/all?sortby=product_name&orderby=asc">All Plants</Dropdown.Item>
              <Dropdown.Item eventKey="3-1-2" href="/browse/plant/moss?sortby=product_name&orderby=asc">Moss</Dropdown.Item>
              <Dropdown.Item eventKey="3-1-3" href="/browse/plant/stem?sortby=product_name&orderby=asc">Stem</Dropdown.Item>
              <Dropdown.Item divider />
            </Dropdown>
